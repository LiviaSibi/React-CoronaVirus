                    ...
                    <div>
                        ...
                        <div className="duvida">
                            ...
                            <div className="question" id="question-3">
                                <h2>Quais são os sintomas que a doença causa?</h2>
                            ...
                            <div className="question" id="question-4">
                                <h2>Como previnir o coronavirus?</h2>
                            ...
                            <div className="question" id="question-5">
                                <h2>O que fazer em caso de sintomas?</h2>
                            ...
                            <div className="question" id="question-6">
                                <h2>Pessoas com o vírus, mas sem os sintomas, podem transmitir a doença?</h2>
                            ...
                            <div className="question" id="question-7">
                                <h2>É possível ser infectado com o coronavírus mais de uma vez?</h2>
                            ...
                            <div className="question" id="question-8">
                                <h2>O que as pessoas que tiveram contato com pacientes suspeitos devem fazer?</h2>
                            ...
                            <div className="question" id="question-10">
                                <h2>Qual é o tempo de incubação do Covid-19?</h2>
                            ...
                            <div className="question" id="question-11">
                                <h2>Qual é a definição de caso suspeito?</h2>
                            ...
                            <div className="question" id="question-12">
                                <h2>O coronavírus pode matar?</h2>
                            ...
                            <div className="question" id="question-13">
                                <h2>Quanto tempo o novo coronavirus sobrevive no ambiente?</h2>
                            ...
                            <div className="question" id="question-14">
                                <h2>Quanto tempo o novo coronavírus sobrevive em uma superfície ou no ar?</h2>
                            ...
                            <div className="question" id="question-15">
                                <h2>Quem deve usar máscara? Ela protege do coronavírus?</h2>
                            ...
                            <div className="question" id="question-16">
                                <h2>Usar luvas seria uma boa ideia?</h2>
                            ...
                            <div className="question" id="question-17">
                                <h2>Como lavar as mãos corretamente?</h2>
                            ...
                            <div className="question" id="question-18">
                                <h2>Existe algum remédio para combater o coronavírus?</h2>
                            ...
                            <div className="question" id="question-19">
                                <h2>Qual(is) remédio(s) a pessoa com COVID-19 deve tomar?</h2>
                            ...
                            <div className="question" id="question-20">
                                <h2>Existe vacina para prevenção ao coronavírus?</h2>
                            ...
                            <div className="question" id="question-21">
                                <h2>Grávidas correm mais riscos?</h2>
                            ...
                            <div className="question" id="question-22">
                                <h2>Como proteger as pessoas idosas da Covid-19?</h2>
                            ...
                            <div className="question" id="question-23">
                                <h2>Posso visitar meus amigos?</h2>
                            ...
                            <div className="question" id="question-24">
                                <h2>Bichos de estimação podem transmitir o coronavírus?</h2>
                            ...
                            <div className="question" id="question-25">
                                <h2>Quanto tempo deve durar a quarentena?</h2>
                            ...
                            <div className="question" id="question-26">
                                <h2>Como manter a rotina de esportes?</h2>
                            ...
                            <div className="question" id="question-27">
                                <h2>Celular é perigoso? É importante higienizá-lo também?</h2>
