          ...
          <div>
            ...
            <div className="question-collection">
              ...
              <div className="question" id="question13">
                <h2 className='faq-h2'>13) Quanto tempo o novo coronavirus sobrevive no ambiente?</h2>
              ...
              <div className="question" id="question14">
                <h2 className='faq-h2'>14) Quanto tempo o novo coronavírus sobrevive em uma superfície ou no ar?</h2>
              ...
              <div className="question" id="question15">
                <h2 className='faq-h2'>15) Quem deve usar máscara? Ela protege do coronavírus?</h2>
              ...
              <div className="question" id="question16">
                <h2 className='faq-h2'>16) Usar luvas seria uma boa ideia?</h2>
              ...
              <div className="question" id="question18">
                <h2 className='faq-h2'>18) Existe algum remédio para combater o coronavírus?</h2>
              ...
              <div className="question" id="question19">
                <h2 className='faq-h2'>19) Qual(is) remédio(s) a pessoa com COVID-19 deve tomar?</h2>
              ...
              <div className="question" id="question20">
                <h2 className='faq-h2'>20) Existe vacina para prevenção ao coronavírus?</h2>
              ...
              <div className="question" id="question21">
                <h2 className='faq-h2'>21) Grávidas correm mais riscos?</h2>
              ...
              <div className="question" id="question22">
                <h2 className='faq-h2'>22) Como proteger as pessoas idosas da Covid-19?</h2>
              ...
              <div className="question" id="question23">
                <h2 className='faq-h2'>23) Posso visitar meus amigos?</h2>
              ...
              <div className="question" id="question24">
                <h2 className='faq-h2'>24) Bichos de estimação podem transmitir o coronavírus?</h2>
              ...
              <div className="question" id="question25">
                <h2 className='faq-h2'>25) Quanto tempo deve durar a quarentena?</h2>
              ...
              <div className="question" id="question26">
                <h2 className='faq-h2'>26) Como manter a rotina de esportes?</h2>
              ...
              <div className="question" id="question27">
                <h2 className='faq-h2'>27) Celular é perigoso? É importante higienizá-lo também?</h2>
